		...
		<div class="grid grid-cols-1 md:grid-cols-4 gap-8">
			...
			<div class="md:col-span-2">
				...
				<p class="text-slate-400 mb-4 max-w-md">
					A modern web application for reading and studying the Holy Quran. Access verses,
					translations, and prayer times with a beautiful, responsive interface.
				</p>
			...
			<div>
				...
				<ul class="space-y-2">
					<li>
						<a href="/" class="text-slate-400 hover:text-emerald-400 transition-colors">Home</a>
					</li>
					<li>
						<a href="/quran" class="text-slate-400 hover:text-emerald-400 transition-colors"
							>Al-Quran</a
						>
					</li>
					<li>
						<a href="/prayer-times" class="text-slate-400 hover:text-emerald-400 transition-colors"
							>Prayer Times</a
						>
					</li>
					<li>
						<a href="/bookmarks" class="text-slate-400 hover:text-emerald-400 transition-colors"
							>Bookmarks</a
						>
					</li>
					<li>
						<a href="/settings" class="text-slate-400 hover:text-emerald-400 transition-colors"
							>Settings</a
						>
					</li>
				</ul>
			...
			<div>
				...
				<ul class="space-y-2">
					<li>
						<button
							type="button"
							class="text-slate-400 hover:text-emerald-400 transition-colors text-left"
							>About</button
						>
					</li>
					<li>
						<button
							type="button"
							class="text-slate-400 hover:text-emerald-400 transition-colors text-left">Help</button
						>
					</li>
					<li>
						<button
			...
			<div class="bg-slate-700 rounded-lg p-6">
				<div class="flex flex-col md:flex-row md:items-center md:justify-between">
					<div class="mb-4 md:mb-0">
						<h4 class="text-lg font-semibold text-emerald-400 mb-2">Sholat Selanjutnya</h4>
						{#if $prayerNextCountdown}
							<p class="text-2xl font-bold text-emerald-400">
								...
								{#if $prayerNextCountdown.nextPrayer && 'isNextDay' in $prayerNextCountdown.nextPrayer && $prayerNextCountdown.nextPrayer.isNextDay}
									<span class="text-sm text-slate-400">(Besok)</span>
								{/if}
							</p>
